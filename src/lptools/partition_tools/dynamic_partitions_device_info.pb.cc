...
PROTOBUF_CONSTEXPR DynamicPartitionsDeviceInfoProto_SuperDevice::DynamicPartitionsDeviceInfoProto_SuperDevice(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.name_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.used_size_)*/::uint64_t{0u}
  , /*decltype(_impl_.total_size_)*/::uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct DynamicPartitionsDeviceInfoProto_SuperDeviceDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DynamicPartitionsDeviceInfoProto_SuperDeviceDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~DynamicPartitionsDeviceInfoProto_SuperDeviceDefaultTypeInternal() {}
  union {  // NOLINT(misc-non-private-member-variables-in-classes)
    DynamicPartitionsDeviceInfoProto_SuperDevice _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DynamicPartitionsDeviceInfoProto_SuperDeviceDefaultTypeInternal _DynamicPartitionsDeviceInfoProto_SuperDevice_default_instance_;
PROTOBUF_CONSTEXPR DynamicPartitionsDeviceInfoProto::DynamicPartitionsDeviceInfoProto(
  ...
  , /*decltype(_impl_.super_device_)*/nullptr
...
static ::_pb::Metadata file_level_metadata_dynamic_5fpartitions_5fdevice_5finfo_2eproto[5];
...
const ::uint32_t TableStruct_dynamic_5fpartitions_5fdevice_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::android::DynamicPartitionsDeviceInfoProto_SuperDevice, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::android::DynamicPartitionsDeviceInfoProto_SuperDevice, _impl_.used_size_),
  PROTOBUF_FIELD_OFFSET(::android::DynamicPartitionsDeviceInfoProto_SuperDevice, _impl_.total_size_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::android::DynamicPartitionsDeviceInfoProto, _impl_.super_device_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 32, -1, -1, sizeof(::android::DynamicPartitionsDeviceInfoProto_SuperDevice)},
  { 41, -1, -1, sizeof(::android::DynamicPartitionsDeviceInfoProto)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::android::_DynamicPartitionsDeviceInfoProto_SuperDevice_default_instance_._instance,
...
const ::_pbi::DescriptorTable descriptor_table_dynamic_5fpartitions_5fdevice_5finfo_2eproto = {
    false, false, 922, descriptor_table_protodef_dynamic_5fpartitions_5fdevice_5finfo_2eproto,
    "dynamic_partitions_device_info.proto",
    &descriptor_table_dynamic_5fpartitions_5fdevice_5finfo_2eproto_once, nullptr, 0, 5,
...
DynamicPartitionsDeviceInfoProto_SuperDevice::DynamicPartitionsDeviceInfoProto_SuperDevice(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:android.DynamicPartitionsDeviceInfoProto.SuperDevice)
}
DynamicPartitionsDeviceInfoProto_SuperDevice::DynamicPartitionsDeviceInfoProto_SuperDevice(const DynamicPartitionsDeviceInfoProto_SuperDevice& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  DynamicPartitionsDeviceInfoProto_SuperDevice* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.name_){}
  ...
  ::memcpy(&_impl_.used_size_, &from._impl_.used_size_,
    ...
    reinterpret_cast<char*>(&_impl_.used_size_)) + sizeof(_impl_.total_size_));
  // @@protoc_insertion_point(copy_constructor:android.DynamicPartitionsDeviceInfoProto.SuperDevice)
}

inline void DynamicPartitionsDeviceInfoProto_SuperDevice::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
inline void DynamicPartitionsDeviceInfoProto_SuperDevice::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.name_.Destroy();
}
...
const char* DynamicPartitionsDeviceInfoProto_SuperDevice::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "android.DynamicPartitionsDeviceInfoProto.SuperDevice.name"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* DynamicPartitionsDeviceInfoProto_SuperDevice::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  if (this->_internal_used_size() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(2, this->_internal_used_size(), target);
  }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData DynamicPartitionsDeviceInfoProto_SuperDevice::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    DynamicPartitionsDeviceInfoProto_SuperDevice::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*DynamicPartitionsDeviceInfoProto_SuperDevice::GetClassData() const { return &_class_data_; }


void DynamicPartitionsDeviceInfoProto_SuperDevice::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<DynamicPartitionsDeviceInfoProto_SuperDevice*>(&to_msg);
  auto& from = static_cast<const DynamicPartitionsDeviceInfoProto_SuperDevice&>(from_msg);
...
void DynamicPartitionsDeviceInfoProto_SuperDevice::InternalSwap(DynamicPartitionsDeviceInfoProto_SuperDevice* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DynamicPartitionsDeviceInfoProto_SuperDevice, _impl_.total_size_)
      + sizeof(DynamicPartitionsDeviceInfoProto_SuperDevice::_impl_.total_size_)  // NOLINT
      - PROTOBUF_FIELD_OFFSET(DynamicPartitionsDeviceInfoProto_SuperDevice, _impl_.used_size_)>(
...
DynamicPartitionsDeviceInfoProto::_Internal::super_device(const DynamicPartitionsDeviceInfoProto* msg) {
  return *msg->_impl_.super_device_;
}
...
DynamicPartitionsDeviceInfoProto::DynamicPartitionsDeviceInfoProto(const DynamicPartitionsDeviceInfoProto& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_super_device()) {
    _this->_impl_.super_device_ = new ::android::DynamicPartitionsDeviceInfoProto_SuperDevice(*from._impl_.super_device_);
  }
...
inline void DynamicPartitionsDeviceInfoProto::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete _impl_.super_device_;
}
...
// @@protoc_insertion_point(message_clear_start:android.DynamicPartitionsDeviceInfoProto)
  ...
  if (GetArenaForAllocation() == nullptr && _impl_.super_device_ != nullptr) {
    delete _impl_.super_device_;
  }
  _impl_.super_device_ = nullptr;
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 50)) {
          ptr = ctx->ParseMessage(_internal_mutable_super_device(), ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
...
::uint8_t* DynamicPartitionsDeviceInfoProto::_InternalSerialize(
  ...
  // .android.DynamicPartitionsDeviceInfoProto.SuperDevice super_device = 6 [json_name = "super_device"];
  if (this->_internal_has_super_device()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(6, _Internal::super_device(this),
        _Internal::super_device(this).GetCachedSize(), target, stream);
  }
...
void DynamicPartitionsDeviceInfoProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_super_device()) {
    _this->_internal_mutable_super_device()->::android::DynamicPartitionsDeviceInfoProto_SuperDevice::MergeFrom(
        from._internal_super_device());
  }
...
void DynamicPartitionsDeviceInfoProto::InternalSwap(DynamicPartitionsDeviceInfoProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(DynamicPartitionsDeviceInfoProto, _impl_.super_device_)>(
          reinterpret_cast<char*>(&_impl_.super_device_),
          reinterpret_cast<char*>(&other->_impl_.super_device_));
}

::PROTOBUF_NAMESPACE_ID::Metadata DynamicPartitionsDeviceInfoProto::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_dynamic_5fpartitions_5fdevice_5finfo_2eproto_getter, &descriptor_table_dynamic_5fpartitions_5fdevice_5finfo_2eproto_once,
      file_level_metadata_dynamic_5fpartitions_5fdevice_5finfo_2eproto[4]);
}
...
template<> PROTOBUF_NOINLINE ::android::DynamicPartitionsDeviceInfoProto_SuperDevice*
Arena::CreateMaybeMessage< ::android::DynamicPartitionsDeviceInfoProto_SuperDevice >(Arena* arena) {
  return Arena::CreateMessageInternal< ::android::DynamicPartitionsDeviceInfoProto_SuperDevice >(arena);
}
